...
public class ImportDialog {
    ...
    public ImportDialog(String fileName, String directory, int widthEDF, int heightEDF, boolean byteOrderEDF, String typeIm, int headSize) {
    	width = widthEDF;
    	height = heightEDF;
    	intelByteOrder = byteOrderEDF;
    	this.headSize = headSize;
    	if(typeIm.toLowerCase().equals("unsignedshort")){
    		choiceSelection = 2;
    	}
    	else{
    		choiceSelection = 5;
...
//        choiceSelection = 5;
        offset = (long)headSize;
        nImages = 1;
        gapBetweenImages = (int)0;
        whiteIsZero = false;
        openAll = false;
        virtual = false;
